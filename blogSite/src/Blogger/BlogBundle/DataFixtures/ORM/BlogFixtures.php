...
class BlogFixtures implements FixtureInterface
{
    public function load(ObjectManager $manager)
    {
    	...
    	$timeTodayFormatted = $timeToday->format('Y-m-d H:i:s');
        $blog1 = new Blog();
        ...
        $blog1->setImage('Chrysanthemum.jpg');
        $blog1->setAuthor('dsyph3r');
        $blog1->setTags('symfony2, php, paradise, symblog');
        $blog1->setComments('asdafadasd');
        $blog1->setCreated($timeTodayFormatted);
        ...
        $blog2->setImage('Hydrangeas.jpg');
        $blog2->setAuthor('Zero Cool');
        $blog2->setTags('pool, leaky, hacked, movie, hacking, symblog');
        $blog2->setComments('asdafadasd');
        $blog2->setCreated($timeTodayFormatted);
        ...
        $blog3->setImage('Jellyfish.jpg');
        $blog3->setAuthor('Gabriel');
        $blog3->setTags('misdirection, magic, movie, hacking, symblog');
        $blog3->setComments('asdafadasd');
        $blog3->setCreated($timeTodayFormatted);
        ...
        $blog4->setImage('Koala.jpg');
        $blog4->setAuthor('Kevin Flynn');
        $blog4->setTags('grid, daftpunk, movie, symblog');
        $blog4->setComments('asdafadasd');
        $blog4->setCreated($timeTodayFormatted);
